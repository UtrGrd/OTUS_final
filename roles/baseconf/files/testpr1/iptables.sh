...
# Локальная сеть
export LAN1=eth1
export LAN1_IP_RANGE=10.10.62.0/24
...
#$IPT -A FORWARD -i $LAN1 -o $WAN2 -j ACCEPT
# Закрываем доступ снаружи в локалку
#$IPT -A FORWARD -i $WAN -o $LAN1 -j REJECT
#$IPT -A FORWARD -i $WAN2 -o $LAN1 -j REJECT


# Включаем NAT
#$IPT -t nat -A POSTROUTING -o $WAN -s $LAN1_IP_RANGE -j MASQUERADE
#$IPT -t nat -A POSTROUTING -o $WAN2 -s $LAN1_IP_RANGE -j MASQUERADE
